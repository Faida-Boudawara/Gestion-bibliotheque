...
{ 
  ...
  { 
        $livres = Livre::with('maised','specialite','auteurs')->get()->toArray();  
  /*  (&) pour modifier directement chaque élément du tableau "$livres".   Cela permet d'accéder à la relation "auteurs" pour chaque livre à l'intérieur de la boucle foreach.         */ 
  ...
  { 
        $livre = new Livre([             'isbn' => $request->input('isbn'),             'titre' => $request->input('titre'),             'annedition' => $request->input('annedition'),             'prix' => $request->input('prix'),             'qtestock' => $request->input('qtestock'),             'couverture' => $request->input('couverture'),             'specialite' => $request->input('specialite_id'),             'maised' => $request->input('editeur_id')           
  ]); 
$livre->save(); 
